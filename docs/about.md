...
- Built a plugin-based task executor in Go supporting dynamic `.so` plugins.
- Designed an API-driven task routing system with retry mechanisms.
...
**Bachelor of Engineering** | *Adani University*
*Aug 2020 – May 2024*
